...
final class DataSetter {
	...
	private lazy var skillsData: Skills = {
		let history = """
				...
				От обучения ожидаю получение знаний различных методов разработки под Swift как графических интерфейсов, так и архитектурных решений. Буду рад стать частью Вашей команды!)
			"""
